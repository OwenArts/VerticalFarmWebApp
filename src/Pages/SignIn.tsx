                        ...
                        <form className="space-y-4 md:space-y-6" action="#">
                            <div>
                                ...
                                <input type="email" name="email" id="email"
                                       className="bg-base-300 border border-gray-300 text-base-content sm:text-sm rounded-lg focus:ring-base-300 focus:border-base-300 block w-full p-2.5 placeholder-base-content"
                                ...
                                <div className="flex items-start">
                                    <div className="flex items-center h-5">
                                        <input id="remember" aria-describedby="remember" type="checkbox"
                                               className="w-4 h-4 border border-gray-300 rounded focus:ring-3 focus:ring-Primary-300 bg-base-300"
                                               required={false} /*checked={localStorage.getItem('theme') === 'night'}*//>
                                    </div>
                                    <div className="ml-3 text-sm">
                                        <label htmlFor="remember" className="font-medium text-base-content">Remember
                                            me </label>
                                    </div>
                                </div>
                                <a href="#"
                                   className="ml-3 font-medium text-primary underline hover:text-secondary">Forgot
                                    password?</a>
                            </div>
                            <button type="submit"
